...
\begin{enumerate}
	...
	\item Injection of random-length NOP loops before every function call immediately preceding a synchronization mechanism.
	\item Injection of random-length NOP loops before every function call immediately following a synchronization mechanism.
\end{enumerate}
