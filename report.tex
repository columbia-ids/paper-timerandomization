...
Because concurrency attacks inherently depend on the timing between and among threads, diversity in thread timing decreases the chance that a successful attack on one system will succeed on another.
